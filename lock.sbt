...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "io.circe" % "circe-jawn_2.12" % "0.9.1",
  "io.circe" % "circe-numbers_2.12" % "0.9.1",
  "io.circe" % "circe-parser_2.12" % "0.9.0",
...
// LIBRARY_DEPENDENCIES_HASH 19294ae27fa044c0b896ae76dd22df98ec0c29ad
