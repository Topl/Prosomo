...
agentName=$(uuidgen)
inputString="input{params{holderIndexMin=$stakeHolderIndex,holderIndexMax=$stakeHolderIndex}} input{scorex{network{declaredAddress=\"$stakeHolderAddress:9084\",upnpEnabled=yes,agentName=\"prosomo_$agentName\"}}}"
