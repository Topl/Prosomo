...
//    })
    ...
    uidef.put("Button.default.background", new ColorUIResource(mainColor3))
    ...
    uidef.put("Component.linkColor", new ColorUIResource(mainColor2))
    uidef.put("CheckBox.icon.focusedBorderColor", new ColorUIResource(mainColor1))
    uidef.put("CheckBox.icon.hoverBorderColor", new ColorUIResource(mainColor2))
    uidef.put("CheckBox.icon.selectedFocusedBorderColor",new ColorUIResource(mainColor2))
    uidef.put("CheckBoxMenuItem.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("ComboBox.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("EditorPane.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("FormattedTextField.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("HelpButton.focusedBorderColor", new ColorUIResource(mainColor1))
    uidef.put("HelpButton.hoverBorderColor", new ColorUIResource(mainColor2))
    uidef.put("List.selectionBackground",new ColorUIResource(mainColor2))
    uidef.put("List.selectionInactiveBackground",new ColorUIResource(mainColor1))
    uidef.put("Menu.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("MenuItem.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("MenuItem.underlineSelectionColor", new ColorUIResource(mainColor2))
    uidef.put("PasswordField.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("ProgressBar.foreground", new ColorUIResource(mainColor2))
    uidef.put("RadioButtonMenuItem.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("TabbedPane.focusColor", new ColorUIResource(mainColor1))
    uidef.put("TabbedPane.hoverColor", new ColorUIResource(mainColor1))
    uidef.put("TabbedPane.underlineColor", new ColorUIResource(mainColor2))
    uidef.put("Table.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("Table.selectionInactiveBackground", new ColorUIResource(mainColor1))
    uidef.put("TextArea.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("TextField.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("textHighlight", new ColorUIResource(mainColor1))
    uidef.put("TextPane.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("ToggleButton.tab.underlineColor", new ColorUIResource(mainColor2))
    uidef.put("Tree.selectionBackground", new ColorUIResource(mainColor1))
    uidef.put("Tree.selectionInactiveBackground", new ColorUIResource(mainColor1))
