...
agentName=$(uuidgen)
inputString="input{params{holderIndexMin=$stakeHolderIndex,holderIndexMax=$stakeHolderIndex}} input{scorex{network{declaredAddress=\"$stakeHolderAddress:9084\",agentName=\"prosomo_$agentName\"}}}"
